<?php
$count = 0;
$recentPosts = new WP_Query('posts_per_page=8');
if ($recentPosts->have_posts()) : ?>
    <?php
		        while ($recentPosts->have_posts()) : $recentPosts->the_post();
		            $count += 1;
                    if($count > 6): ?>
                        <div class="col-sm-12 col-md-4 blog-front-page mb-5">
                            <div class="thumbnail">
                                <div class="card">
                                    <?php
                                    ...
                                    <div class="card-body">
                                        ...
                                        <a class="p-absolute" href="<?php the_permalink();?>" title="<?php echo get_the_title(); ?>">বিস্তারিত&raquo;</a>
