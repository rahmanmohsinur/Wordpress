    ...
    <div class="container">
        ...
        <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#collapsibleNavbar">
            ...
            <div class="collapse navbar-collapse" id="collapsibleNavbar" itemscope itemtype="https://schema.org/SiteNavigationElement">
                ...
                <li class="nav-item deeper dropdown parent <?php if( is_month() ) {?>active<?php } ?>">
                    ...
                    <ul class="dropdown-menu" role="menu">
                        ...
                        foreach($months as $month) :
                            ...
                            <li class='arcive-link-item'> <!-- href="<?php bloginfo('url') ?>/<?php echo $month->year; ?>/<?php echo date("m", mktime(0, 0, 0, $month->month, 1, $month->year)); ?>" -->
		                        <a class='inline dropdown-item' href="<?php echo get_month_link($month->year, date("m", mktime(0, 0, 0, $month->month, 1, $month->year))); ?>">
                                    ...
                                    <span class='inline badge'><?php echo bangla_number($month->post_count); ?></span></a>
	                        </li>
	                    <?php 
                ...
                <li class="nav-item  <?php if( is_page('videos') ) {?>active<?php } ?>"><a class="nav-link" href="http://mohammadmohsin.altervista.org/blog/videos"><i class="fab fa-youtube"></i> ভিডিও</a></li>
            </ul>
            <?php 
            $args = array(
